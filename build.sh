...
make_efi() {
    ...
    # For 32-bit UEFI
    curl -o ${work_dir}/iso/EFI/boot/bootia32.efi -L https://github.com/deltabeard/ia32-uefi-archlive/raw/master/Loader.efi
    curl -o ${work_dir}/iso/EFI/boot/HashTool.efi -L https://github.com/deltabeard/ia32-uefi-archlive/raw/master/HashTool.efi

    #cp ${work_dir}/x86_64/airootfs/usr/lib/gummiboot/gummibootx64.efi ${work_dir}/iso/EFI/boot/loader.efi
    # 32-bit gummiboot
    curl -o ${work_dir}/iso/EFI/boot/loader.efi -L https://github.com/deltabeard/ia32-uefi-archlive/raw/master/gummibootia32.efi
    ...
    # 32-bit gummiboot
    curl -o ${script_path}/efiboot/loader/entries/archiso-i686-usb.conf -L https://github.com/deltabeard/ia32-uefi-archlive/raw/master/archiso-i686-usb.conf
...
make_efiboot() {
    ...
    # For 32-bit UEFI
    curl -o ${work_dir}/efiboot/EFI/boot/bootia32.efi -L https://github.com/deltabeard/ia32-uefi-archlive/raw/master/Loader.efi
    curl -o ${work_dir}/efiboot/EFI/boot/HashTool.efi -L https://github.com/deltabeard/ia32-uefi-archlive/raw/master/HashTool.efi

    #cp ${work_dir}/x86_64/airootfs/usr/lib/gummiboot/gummibootx64.efi ${work_dir}/efiboot/EFI/boot/loader.efi
    # 32-bit gummiboot
    curl -o ${work_dir}/efiboot/EFI/boot/loader.efi -L https://github.com/deltabeard/ia32-uefi-archlive/raw/master/gummibootia32.efi
    ...
    # 32-bit gummiboot
    curl -o ${script_path}/efiboot/loader/entries/archiso-i686.conf -L https://github.com/deltabeard/ia32-uefi-archlive/raw/master/archiso-i686-usb.conf
    ...
    sed "s|%ARCHISO_LABEL%|${iso_label}|g;
         s|%INSTALL_DIR%|${install_dir}|g" \
        ${script_path}/efiboot/loader/entries/archiso-i686.conf > ${work_dir}/efiboot/loader/entries/archiso-i686.conf
